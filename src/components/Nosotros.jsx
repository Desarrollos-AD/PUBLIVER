...
import mision from "../assets/img/logro.png";
          ...
          <div className="quienes_somos">
            ...
            <div className="quienes_somos--des">
              <p>
                ...
                dedicada a impulsar el crecimiento y posicionamiento de las
                marcas en entornos altamente competitivos. Nuestro objetivo es
                fortalecer la identidad de marca y maximizar su impacto,
                desarrollando estrategias de comunicación efectivas que conecten
                con las audiencias a través de múltiples canales, tanto
                tradicionales como digitales. Trabajamos de la mano con
                empresas, marcas y organizaciones que buscan diferenciarse,
                comunicar con claridad y tomar decisiones estratégicas basadas
                en información real, análisis profundo y datos confiables. Cada
                proyecto es abordado de manera personalizada, integrando
                creatividad, investigación y estrategia para lograr resultados
          ...
          <div className="quienes_somos__puntos--info">
            <div className="card__pilares">
              <div className="card__pilares--pilar">
                ...
                <p>
                  Diseñamos soluciones basadas en análisis de mercado, objetivos
                  comerciales y comportamiento del consumidor, asegurando que
                  cada acción tenga un propósito claro y alineado a la
                  marca.{" "}
                </p>
              </div>
          ...
          <div className="compromiso">
            ...
            <div className="contigo">
              <div className="contigo__conten1">
                <div className="contigo__conten1--img">
                  <img
                    className=""
                    src={dest1}
                    alt="Rome, Italty"
                ...
                <div className="contigo__conten1--info">
                  <p className="">
                    ...
                    fortalezcan relaciones a largo plazo. Nuestro enfoque
                    combina análisis, creatividad y estrategia para que cada
                    mensaje refleje los valores de la marca y tenga un impacto
                    positivo y duradero en su público.
                  </p>
                </div>
              </div>

              <div className="contigo__conten2">
                <div className="contigo__conten2--img">
                  <img
                    className=""
                    src={dest2}
                    alt="London, UK"
                ...
                <div className="contigo__conten2--info">
                  <p className="">
                    ...
                    bien estructurada. Visualizamos un entorno donde las marcas
                    no solo se vean, sino que se sientan y se recuerden. En
                    Publiver, aspiramos a ser el puente estratégico entre las
                    marcas y las emociones de sus clientes, transformando ideas
                    en experiencias, mensajes en conexiones reales y estrategias
                    en resultados que impulsen el crecimiento y la consolidación
                    de cada negocio.
                  </p>
                </div>
              </div>
          ...
          <div className="valores ">
            ...
            <div className="valores__mision">
              <div className="valores__mision--content">
                ...
                <p>
                  ...
                  crecimiento de las marcas, ayudando a nuestros clientes a
                  tomar decisiones estratégicas mediante información confiable,
            ...
            <div className="valores__vision">
              <div className="valores__vision--content">
                <h3>Visión</h3>
                <p>
                  Ser la empresa líder en consultoría publicitaria y
                  mercadotecnia en la región, reconocida por su capacidad de
                  análisis, creatividad estratégica y efectividad en la
                  ejecución, convirtiéndonos en el socio estratégico de marcas y
